...
<div id="content-wrapper">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Generación de pines por fecha</li>
    </ol>
    <!--/.breadcrumbs-->
...
<script>
	function updateChar(cant, fechas, cargas, mes)
	{
	    ...
	    if (mes==0)
	    {
	    	myChart.options.title.text = 'Generación de pines por fecha: Todas las generaciones';
	    } else {

	    	myChart.options.title.text = 'Generación de pines del mes de '+mes;
	    }
	...
	$(document).on('change', '#filtro', function (e){
	    ...
	    let a = url.indexOf("generacion");
	    let b = '';

	        if (filtro == 0) {
	            b = url.slice(0,a) + 'allDatesPines';
	        } else {
	        	b = url.slice(0,a) + 'dateChangePines';
	        }
	...
	let contenido = {
	    ...
	    options: {
	        ...
	        title: {
	            display: true,
	            text: 'Generacion de pines por fecha'
	        },
	...
	$('#line').click(function () {
	    ...
	    myChart.options.title.display = false;
	    myChart.update();
	    console.log('updated');
	});
	//----------Fin prueba----------
